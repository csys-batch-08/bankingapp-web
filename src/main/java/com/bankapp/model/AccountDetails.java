...
public class AccountDetails {
	...
	public AccountDetails(int userId, long accountNumber, String accountType, String accountHolderName, String address,
			String city, int pincode, LocalDate dob, long mobileNumber, String email, String ifscCode,
	...
	public String toString() {
		return "AccountDetails [user_id=" + userId + ", account_number=" + accountNumber + ", account_type="
				+ accountType + ", account_Holder_name=" + accountHolderName + ", address=" + address + ", city=" + city
				+ ", pincode=" + pincode + ", dob=" + dob + ", mobile_Number=" + mobileNumber + ", email=" + email
				+ ", ifsc_Code=" + ifscCode + ", branchName=" + branchName + ", balance=" + balance + ", pin_Number="
