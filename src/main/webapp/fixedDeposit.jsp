			...
			<table>
				  <caption>
					<tr>
						...
						<td><input type="text" name="accNo" id="accNum"class="cls"
							pattern="[0-9]{12,14}" required autofocus /></td>
					</tr>
					<tr>
						<th id="thead1"><label for="amount">Amount to Deposit</label></th>
						<td><input type="text" name="amountDeposit" id="amount" class="cls"
