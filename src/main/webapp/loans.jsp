...
<body>
	...
	<br>
	<br>
	<h2 align="center">Personal Loan Starting at 10.00%</h2>
	<br>
	<h3 align="center">Apply for an online personal loan at low
	...
	<ul>
		...
		<li>Compare 100+ personal loan banks at MyMoneyMantra and choose
			the best one.</li>
		<br>
		<li>Check fees & charges of all top banks offering personal loans
			in india.</li>
		<br>
	...
	<br>
	<br>
	<h3 class="h4">Features & Benefits of Personal Loan</h3>
	<br>
	<li><b>The rate of Interest:</b> The Rate of Interest on Personal
		Loans/ Annual Percentage Rate (APR) is between 9.6%-24% depending on
		your credit score, income and so forth.</li>
	<br>
	<li><b>Loan amount:</b> You can get a loan online for as low as
		10,000 and as high as 50 Lakhs depending on your requirement and
		eligibility.</li>
	<br>
	<li><b>Loan tenure:</b> Personal loans are available for periods
		as short as 12 months. The average tenure for a Personal Loan is
		between 12 and 60 months,depending on the loan amount.</li>
	<br>
	<li><b>Security: </b>Due to its unsecured nature, collateral is
		not required.</li>
	<br>
	<li><b>Loan turnaround time: </b>A Personal Loan typically has the
		fastest turnaround time in the industry. Many banks personal loans
		online approval within 48 hours after submission of the online
		application.</li>
	<br>
	<li><b>Processing fees: </b>It depends on the individual bank. It
		usually ranges between 500 to - 2.5% of the loan amount.</li>
	<br>
	<li><b>Prepayment penalty: </b>Banks charge prepayment penalty if
	...
	<br>
	<br>
	<h2 align="center">Housing Loan</h2>
	<br>
	...
	<ul>
		...
		<br>
		<li>Takeover or balance transfer of existing Home Loans possible</li>
		<br>
</body>
</html>